    ...
    <main>
        <other_stuff class="userList">
            <ul class="titleOfTable">
                <li><a style="color: black">STUDENT LIST</a></li>
            ...
            <ul class="columnLabels">
                ...
                <li id="column4"><a style="color: #958d8d">FORM</a></li>
            </ul>
...
<script>
    let StudentData = <?= json_encode($StudentInfo) ?>;
    console.log(StudentData);
</script>
<script src="ADMIN_JS/adminDisplayStudentList.js"></script>
