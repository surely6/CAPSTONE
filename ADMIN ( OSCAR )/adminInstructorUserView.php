    ...
    <main>
        <other_stuff class="userList">
            <ul class="titleOfTable">
                <li><a style="color: black">INSTRUCTOR LIST</a></li>
...
<script>
    let InstructorData = <?= json_encode($InstructorInfo) ?>;
    console.log(InstructorData);
</script>
<script src="ADMIN_JS/adminDisplayInstructorList.js"></script>
