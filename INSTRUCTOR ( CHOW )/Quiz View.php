...
$unfinsihedQUERY = "SELECT `quiz_id`,`quiz_title`, `quiz_chapter`,`quiz_total_questions`, `quiz_subject`, `quiz_level` ,`date_made`
FROM quizzes WHERE `instructor_id` = '$instructorID' AND `completion_status` = '0'";
...
$finsihedQUERY = "SELECT `quiz_id`,`quiz_title`, `quiz_chapter`,`quiz_total_questions`, `quiz_subject`, `quiz_level`, `date_made`
FROM quizzes WHERE `instructor_id` = '$instructorID' AND `completion_status` = '1'";
$finishedSQL = mysqli_query($conn, $finsihedQUERY);
...
<body>
    ...
    <div style="position: relative;">
        ...
        <btn id="OpenFilter" onclick="ShowFilter()"><i class="bi bi-list"
                style="color: var(--grey);cursor:pointer;"></i></btn>
        <!-- the side bar -->
        <div id='filter'>
            ...
            <div class="CheckSection">
                ...
                <div class="check-dropdown-list" id="forms" style="overflow-y: hidden;">
                    <label for="form"> <input type="checkbox" id="form" name="quiz_level" value="1"> FORM 1</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_level" value="2"> FORM 2</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_level" value="3"> FORM 3</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_level" value="4"> FORM 4</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_level" value="5"> FORM 5</label>
                </div>
            </div>
            <div class="CheckSection">
                <!-- insert dropdown list id into function -->
                ...
                <div class="check-dropdown-list" id="subjects">
                    <label for="english"> <input type="checkbox" id="english" name="quiz_subject" value="english">
                        ENGLISH</label>
                    <label for="malay"> <input type="checkbox" id="malay" name="quiz_subject" value="malay">
                        MALAY</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="mathematics">
                        MATHEMATICS</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="science">
                        SCIENCE</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="history">
                        HISTORY</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="geography">
                        GEOGRAPHY</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="accounting">
                        ACCOUNTING</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="economy">
                        ECONOMY</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="business">
                        BUSINESS</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="add maths">
                        ADDITIONAL MATHEMATICS</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="physics">
                        PHYSICS</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="chemistry">
                        CHEMISTRY</label>
                    <label for="form"> <input type="checkbox" id="form" name="quiz_subject" value="biology">
                        BIOLOGY</label>
                </div>
            </div>
        </div>
    ...
    <script>
        let unfinished = <?= isset($unfinished) ? json_encode($unfinished) : '[]' ?>;
        let finished = <?= isset($finished) ? json_encode($finished) : '[]' ?>;
    </script>
    <script src="RESOURCES/JAVA/View Quiz.js"></script>
    <script>
        function EditQuiz(id) {
            document.cookie = "ID = " + id + ";"
            document.cookie = "ORIGIN= Quiz View.php;"
            window.location.href = "Quiz Edit.php";
        }

        function SummaryQuiz(id) {
            document.cookie = "ID = " + id + ";"
            window.location.href = "Quiz Summary.php";
        }
